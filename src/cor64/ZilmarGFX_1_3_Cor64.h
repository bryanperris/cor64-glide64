...
typedef struct {
    ...
    ptr_VidExt_ListFullscreenRates   CoreVideo_ListFullscreenRates;
    ptr_VidExt_SetVideoMode          CoreVideo_SetVideoMode;
    ptr_VidExt_SetVideoModeWithRate  CoreVideo_SetVideoModeWithRate;
    ...
    ptr_VidExt_GL_GetAttribute       CoreVideo_GL_GetAttribute;
    ptr_VidExt_GL_SwapBuffers        CoreVideo_GL_SwapBuffers;
    ptr_VidExt_GL_GetDefaultFramebuffer CoreVideo_GL_GetDefaultFramebuffer;
} MUPEN_VID_EXT;
